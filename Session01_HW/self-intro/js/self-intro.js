(() => {
	...
	const sceneInfo = [
		...
		},
		{
			...
			objs: {
				...
				pinC: document.querySelector('#scroll-section-1 .c .pin'),
	...
	function setCanvasImages() {
		...
		for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
			imgElem = new Image();
			imgElem.src = `./video/005/scene${1 + i}.png`;
        ...
        */
		...
		for (let i = 0; i < sceneInfo[1].values.videoImageCount; i++) {
			imgElem1 = new Image();
			imgElem1.src = `./video/005/scene${1 + i}.png`;
		...
		for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
			imgElem2 = new Image();
			imgElem2.src = `./video/006/scene${1 + i}.png`;
	...
	function loop() {
		...
		if (!enterNewScene) {
			if (currentScene === 0 || currentScene === 1 || currentScene === 2 || currentScene === 3) {
